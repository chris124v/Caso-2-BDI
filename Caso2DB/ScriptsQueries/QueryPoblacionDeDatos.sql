...
--- Insercion de tipos de Log ---

insert into SocaiLogTypes (name)

values  ('Información'), ('Advertencia'),
    ('Error'),('Transacción'),('Seguridad');

select * from SocaiLogTypes;


--- Insercion de origenes de Log ---

insert into SocaiLogSources (name)

values
    ('Sistema'),('Aplicacion Movil'),
    ('Sitio Web'),('API'),('Base de Datos');

select * from SocaiLogTypes;

--- Insercion de Log Severities ---

insert into SocaiLogSeverities (name, lastUpdate)
...
select * from SocaiLogSeverities;

---Insercion de CurrenyExchange ----
